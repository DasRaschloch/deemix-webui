const gr = {
	...
	toasts: {
		...
		alreadyDownloaded: 'Το {item} έχει ήδη ληφθεί',
	...
	settings: {
		...
		downloads: {
			...
			filterByReleaseDate: 'Φιλτράρισμα ανά ημερομηνία κυκλοφορίας',
			...
			filterDate: 'Λήψη όλων όσων κυκλοφόρησαν μετά την ορισμένη ημερομηνία',
