		...
		spotify: {
			...
			howTo: {
				...
				questionOne: {
					...
					stepThree:
						'Συμπληρώστε τα πεδία "Όνομα εφαρμογής" και "Περιγραφή εφαρμογής" και επιλέξτε και τα δύο "checkboxes". Στη συνέχεια κάντε κλικ στο κουμπί "Create".\n',
					stepThreeAlt: 'Κουμπί δημιουργία φόρμας εφαρμογής',
					stepFour:
						'Τώρα μπορείτε να δείτε το "Client ID". Εάν κάνετε κλικ στο "Show Client Secret" το μυστικό του πελάτη θα αποκαλυφθεί.\n',
